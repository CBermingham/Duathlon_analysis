...
plt.subplot(3, 2, 1)
plt.scatter(run1_female, ride_female, color = 'darkturquoise', label = "Female")
plt.scatter(run1_male, ride_male, color = 'darkviolet', label = "Male")
...
plt.subplot(3, 2, 3)
plt.scatter(run1_female, run2_female, color = 'darkturquoise')
plt.scatter(run1_male, run2_male, color = 'darkviolet')
...
plt.subplot(3, 2, 5)
plt.scatter(ride_female, run2_female, color = 'darkturquoise')
plt.scatter(ride_male, run2_male, color = 'darkviolet')
...
plt.subplot(3, 2, 2)
plt.scatter(total_female, run1_female, color = 'darkturquoise', label = "Female")
plt.scatter(total_male, run1_male, color = 'darkviolet', label = "Male")
plt.scatter(total[169], run1[169], color = 'r')
plt.plot(total, yt1fit, color = 'g')
plt.xlabel("total (mins)")
plt.ylabel("run1 (mins)")

plt.subplot(3, 2, 4)
plt.scatter(total_female, ride_female, color = 'darkturquoise', label = "Female")
plt.scatter(total_male, ride_male, color = 'darkviolet', label = "Male")
plt.scatter(total[169], ride[169], color = 'r')
plt.plot(total, yt2fit, color = 'g')
plt.xlabel("total (mins)")
plt.ylabel("ride (mins)")

plt.subplot(3, 2, 6)
plt.scatter(total_female, run2_female, color = 'darkturquoise', label = "Female")
plt.scatter(total_male, run2_male, color = 'darkviolet', label = "Male")
plt.scatter(total[169], run2[169], color = 'r')
plt.plot(total, yt3fit, color = 'g')
plt.xlabel("total (mins)")
plt.ylabel("run2 (mins)")
